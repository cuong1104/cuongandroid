...
public class DateUtils {
    ...
    public static final String[] CAN = {"Giáp", "Ất", "Bính", "Đinh", "Mậu", "Kỷ", "Canh", "Tân", "Nhâm", "Qúy"};
    public static final String[] CHI = {"Tí", "Sửu", "Dần", "Mão", "Thìn", "Tỵ", "Ngọ", "Mùi", "Thân", "Dậu", "Tuất", "Hợi"};
    ...
    /**
     * Get Name of year in Lunar (CanChi)
     *
     * @return Can+" "+Chi
     */
    ...
    /**
     * Get Solar of 1/11/year(in Lunar)
     * @param Y year
     * @return solar (dd/MM/yyyy)
     */
     ...
     * Get Lunar
     *
     * @return lunar time (dd/MM/yyyy/leap)
     */
    public int[] getLunar() {
        int yy = this.year;
    ...
    /**
     * Convert Lunar to Solar (Am lich -> Duong lich)
     *
     * @param D    day in Lunar
     * @param M    month in Lunar
     * @param Y    year in Lunar
     * @param leap leap (1 if is leap, 0 if not)
     * @return solar (dd/MM/yyyy)
     */
